...
Most squirrels are spotted on the ground. These built-in columns gives some detail about where these acorn-lovers spend their days, but we can do better! Let's combine this location data by activity:
